...
export default function RequestHistory() {
  ...
  return (
    <div className="xl:bg-white rounded-lg shadow-md overflow-x-auto p-4 md:p-6 xl:p-6 w-full max-w-7xl mx-auto">
      <h2 className="text-md sm:text-lg font-semibold mb-4">Request History</h2>


      <div className="bg-white overflow-y-auto max-h-[calc(100vh-400px)] xl:max-h-[calc(90vh-400px)]">

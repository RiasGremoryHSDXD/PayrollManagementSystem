...
export default function PayrollApproved({
  ...
  const [additionalBenefitsAmount, setAdditionalBenefitsAmount] =
    useState<string>("0");
  const [voluntaryDeductionAmount, setVoluntaryDeductionAmount] =
    useState<string>("0");
  const [voluntaryDeductionDescription, setVoluntaryDeductionDescription] =
    useState<string>("");
  const [outstandingLoansOriginal, setOutstandingLoansOriginal] =
    useState<string>("0");
  const [outstandingLoansPrincipalRepaid, setOutstandingLoansPrincipalRepaid] =
    useState<string>("0");
  const [outstandingLoansInterestRate, setOutstandingLoansInterestRate] =
    useState<string>("0");
  ...
  const handleDeductionDetail = async () => {
    ...
    setOutstandingLoansPrincipalRepaid(
      d.outstanding_loans_principal_repaid ?? "0"
    );

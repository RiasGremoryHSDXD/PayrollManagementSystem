...
import { validUserClockIn, userOnLeave } from "../SupabaseFunction/ValidateClockIn";
...
export default function AttendanceForm() {
  ...
  const [employeeScheduleID, setEmployeeScheduleID] = useState<number>(parseInt(localStorage.getItem('employeeScheduleID')!, 10));
  ...
  const handleClockAction = async () => {
    ...
    const validatedUserClockIn = await validUserClockIn(date, employeeScheduleID)
          ...
          >
            <div className="bg-red-50 w-80 p-6 rounded-xl shadow-lg border-2 border-red-500">
              ...
              <h1 className="text-red-700 mb-6 text-sm text-center">
                You have pending or approved leave today.<br/>

      ...
      >        
        <div className='header-container'>
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <title>egghead</title>
            <path d="M11.998 0c-1.649 0-3.223.893-4.679 2.655-.934 1.134-1.818 2.638-2.567 4.368-1.338.207-2.399.48-3.143.814a2.04 2.04 0 0 0-1.21 
          ...
          <h2 className='mt-4 md:mt-[16px] text-xl md:text-2xl font-bold font-[Helvetica Neue]'>Enterprise Portal</h2>
          <p className='mt-2 md:mt-[8px] text-sm md:text-base  text-gray-600 font-[Segoe UI]'>Log in to access your account</p>
        ...
        <div className="input-container">
          <div className="email-container">
            <label htmlFor="Email" className='block font-[Helvetica Neue] text-sm md:text-base mb-1 text-gray-800 font-semibold font-sans'>Email Address</label>
            <input
              type="email"
          ...
          <div className="pass-container">
            <label htmlFor="Password" className='font-[Helvetica Neue] text-sm text-gray-800 font-semibold font-sans'>Password </label>
            <input
              type="password"
              placeholder="••••••"
              value={userPassword}
